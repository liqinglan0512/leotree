...
test("every hand-over the og skill prints is one this script accepts", { skip: !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/references")) ? "Review bundle omits generated OG skill references" : false }, () => {
